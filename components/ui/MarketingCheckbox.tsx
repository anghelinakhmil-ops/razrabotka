...
/**
 * MarketingCheckbox — optional GDPR marketing consent
 *
 * Separate from main consent (GDPR requires separate opt-in for marketing).
 * This checkbox is NOT required for form submission.
 */
export const MarketingCheckbox = forwardRef<HTMLInputElement, MarketingCheckboxProps>(
  function MarketingCheckbox(
    { name, checked, onChange, onBlur, disabled, inverted = false },
    ref,
  ) {
